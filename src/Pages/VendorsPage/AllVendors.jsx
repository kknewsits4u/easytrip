...
const AllVendors = () => {
  ...
  return (
    <div className=" flex flex-col items-center  justify-start  max-w-[1440px] w-full min-h-[100vh] h-fit   px-2 gap-2 bg-white py-2">
      <div className="grid max-lg:grid-cols-1 grid-cols-[1fr_2fr] gap-3 max-md:gap-3  w-full  h-fit ">
        <div className="rounded-[2rem] rounded-tl-md rounded-tr-md overflow-hidden shadow-lg bg-white h-fit">
          <div className="relative bg-[#FA812F]  h-32 md:h-48 rounded-b-[3rem]">
          ...
          <div className="mt-18 text-center px-6 pb-6">
            <h2 className="text-lg font-bold text-gray-800">Prince Kumar</h2>
            <p className="text-base text-gray-600">Photographer</p>
            <div className="flex items-center flex-col justify-start w-full mt-5 gap-5">
              <h1 className=" text-orange-400 font-semibold max-md:text-base  text-lg">
                Follow Us
              </h1>
              <div className=" flex items-center justify-center gap-5 ">
                {iconsData.map((data, idx) => (
                  <div
                    key={idx}
                    className=" flex items-center justify-center w-12 h-12 rounded-full shadow shadow-orange-400 cursor-pointer "
                  >
                    <img
                      src={data.icon}
                      alt="socilaIcons"
            ...
            <div className="max-lg:flex-col  flex  flex-row items-center justify-between w-full h-fit max-md:mt-5  mt-10 border-t border-gray-300 pt-5 gap-5">
              ...
              <div className=" flex items-center justify-center gap-3 max-lg:w-full w-auto">
                <div
                  className="max-lg:w-[80%] w-auto flex items-center justify-center px-3 py-1 text-[rgb(255,255,255)] border-2 border-orange-400 bg-orange-400 hover:bg-white hover:text-orange-400 rounded-md font-medium "
        ...
        <div className=" flex flex-col w-full  items-start justify-start gap-3">
          <div className=" flex flex-col items-start justify-start w-full px-3  py-1 gap-3 h-fit shadow-md rounded-md border border-gray-100 divide-y divide-gray-300 ">
            <h1 className="w-full text-left pb-2 max-md:text-lg max-lg:text-lg text-xl font-semibold text-gray-800  ">
              Photography Categories{" "}
            </h1>
            <div className=" grid max-md:grid-cols-1 grid-cols-2 w-full h-fit gap-5">
              <div className="relative flex items-center justify-center h-48 md:h-52 lg:h-56 xl:h-60  rounded-md  w-full  ">
                <img
                  src="https://i.pinimg.com/736x/0f/70/be/0f70bebd7d0752ea93e8a2e4625232c7.jpg"
                ...
                <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-black/40 to-transparent rounded-md p-3 flex items-end justify-start ">
                  <h1 className="text-white font-semibold max-md:text-base max-lg:text-lg text-xl">
                    Pre-Wedding Photography
                  </h1>
                </div>
              </div>
              <div className="relative flex items-center justify-center  rounded-md h-48 md:h-52 lg:h-56 xl:h-60 w-full">
                <img
                  src="https://i.pinimg.com/736x/89/56/95/8956955fb168a1c43870cd9ad7d84d66.jpg"
                  alt="pre-wedding image"
                  className=" w-full h-full object-cover object-center rounded-md "
                />
                <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-black/40 to-transparent rounded-md p-3 flex items-end justify-start ">
          ...
          <div className=" flex flex-col items-start justify-start w-full px-3  py-1 gap-3 max-md:min-h-fit min-h-60  shadow-md rounded-md border border-gray-100 divide-y divide-gray-300 ">
            ...
            <div className=" flex w-full h-fit gap-5 py-2">
              ...
              <button
                type="button"
                className=" flex items-center justify-center text-white hover:text-orange-400 font-semibold bg-orange-400 hover:bg-white cursor-pointer px-3 rounded-md  border hover:border-orange-400 "
              >
                Check
              </button>
            </div>
            {open && (
              <div className=" flex items-center justify-start w-full ">
                {isBooked == true ? (
                  <h1>Already booked on this date.....</h1>
                ) : (
      ...
      <div className="flex flex-col items-center justify-start w-full  h-fit  shadow rounded mt-3 bg-[rgb(250,250,250)] ">
        <div className=" flex items-center  justify-start w-full px-4 py-3 font-semibold max-md:text-lg max-lg:text-lg text-xltext-gray-800 border-b-2 border-gray-300 bg-white">
          Latest Bookings
        </div>
        <div className=" grid max-md:grid-cols-1 grid-cols-2 items-center gap-2 md:gap-4 justify-start w-full max-md:px-2 px-4 py-2 ">
          {[1, 2].map((idx) => (
            <BookingCard key={idx} />
          ))}
        </div>
