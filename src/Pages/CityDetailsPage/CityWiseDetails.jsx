...
const CityWiseDetails = () => {
  ...
  [
    {
      "name":"Banquet",
      "image":"https://i.pinimg.com/736x/0c/96/bd/0c96bd781be32d186e2a9b407b60bd22.jpg"
    },
    {
      "name":"Hotel",
    ...
    {
      "name":"Party Hall",
      "image":"https://i.pinimg.com/736x/89/c8/3a/89c83a762fe2c59d0659fec9703e49fb.jpg"
    },
    {
      "name":"Marriage Home",
      "image":"https://i.pinimg.com/736x/69/6d/92/696d924a5c649caa726db7a496410d90.jpg"
    },
  ]
  ...
  [
    ...
    },
    {
      ...
      "image":"https://i.pinimg.com/736x/3e/1c/58/3e1c580ca4c87e46cedc3834056188a3.jpg"
    },
  ]
    ...
    <div className=' flex flex-col max-w-[1440px] w-full min-h-50  items-center  bg-white ' >
       <div className=' relative flex items-center justify-center w-full h-[60vw] md:h-[45vw] lg:h-[30vw] ' >
          <div  className=' flex items-center justify-center w-full h-full '  >
             <img src="https://cdn.pixabay.com/photo/2016/11/23/17/55/atoll-1854069_1280.jpg" alt="detaiImage"  className='w-full h-full object-cover object-center   '  />
          </div>
          
          <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-black/50 to-transparent text-white flex items-end  justify-center pb-5 xl:pb-10 ">
            <h1 className='max-sm:text-2xl  lg:text-3xl  xl:text-5xl font-semibold ' >Plan your wedding in <span>{currentCity}</span></h1>
          </div>
       </div>

       <div className='flex w-full h-fit flex-col items-start max-w-[1280px]  pt-5'  >
        <h1 className=' w-full text-left px-3  max-md:text-base max-lg:text-lg text-2xl font-semibold ' >View By Category</h1>
       ...
       <h1 className=' w-full text-left px-3  max-md:text-base max-lg:text-lg text-2xl font-semibold ' >Popular Categories</h1>
          <div className=' grid max-md:grid-cols-2 max-lg:grid-cols-3 grid-cols-4 w-full px-3 gap-2' >
                {
                  popularCategory.map((d, idx )=>
                  (
                    <div key={idx}  className='group flex flex-col items-center justify-between max-md:h-45 max-lg:h-50 h-70 rounded-md  border border-gray-300  w-full relative cursor-pointer  hover:shadow-md ' >
                      <div className='flex items-center justify-center w-full h-full rounded-md'  >
                      <img src={d.image} alt="hotel-image" className='w-full h-full object-cover object-center rounded-md  ' />
                       </div>
       ...
       <h1 className=' w-full text-left px-3  max-md:text-base max-lg:text-lg text-2xl font-semibold ' >Other Categories</h1>
          <div className=' grid max-md:grid-cols-2 max-lg:grid-cols-3 grid-cols-4 w-full px-3 gap-2' >
                {
                  otherCategory.map((d, idx )=>
                  (
                    <div key={idx}  className=' flex flex-col items-center justify-between max-md:h-45 max-lg:h-50 h-70 rounded-md  border border-gray-300  w-full relative cursor-pointer  hover:shadow-md group ' >
                      <div className='flex items-center justify-center w-full h-full rounded-md'  >
                      <img src={d.image} alt="hotel-image" className='w-full h-full object-cover object-center rounded-md  ' />
                       </div>
                       <div className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t from-black/40 to-transparent flex items-end justify-center rounded-md">
