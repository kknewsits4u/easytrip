      ...
      >
        ...
        <div className="hidden md:flex items-center justify-between   ">
          <ul className="flex  items-center justify-between gap-7 text-md xl:text-lg font-semibold">
            <li    className=" cursor-pointer hover:text-[rgb(239,74,107)]" >Home</li>
            <li    className=" cursor-pointer hover:text-[rgb(239,74,107)]" >Hotels</li>
            <li  className=" cursor-pointer hover:text-[rgb(239,74,107)]" >Flights</li>
            <li  className=" cursor-pointer hover:text-[rgb(239,74,107)]" >Cabs</li>
            <li  className=" cursor-pointer hover:text-[rgb(239,74,107)]" >Login</li>
          </ul>
        </div>
        <div
