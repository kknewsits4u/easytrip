  ...
  return (
    ...
    >
      <div className=' flex flex-col lg:flex-row items-center justify-between h-full w-1/2 gap-5' >
         <h1 className='text-2xl font-semibold text-[#dd2476]' >Easy <span className='text-white px-3 rounded'     style={{
      ...
      <div className=' flex flex-col items-center justify-start h-full w-1/2  gap-4' >
        <h1 className='font-semibold text-lg lg:text-2xl text-black' >Follow Us</h1>
